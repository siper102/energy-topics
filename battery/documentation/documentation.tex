...
\begin{equation}
    \min J = \sum_{t=1}^{N} \left[ \left( \lambda^{buy}_t P_{buy,t} - \lambda^{sell}_t P_{sell,t} + \lambda^{grid} (P_{buy,t} + P_{sell,t}) \right) \Delta t + \alpha \left( P_{ch,t}^2 + P_{dis,t}^2 \right) \right]
\end{equation}
...
\begin{equation}
\begin{aligned}
\min_{\mathbf{P}, \mathbf{E}} \quad & \sum_{t=1}^{N} \left[ \left( \lambda^{buy}_t P_{buy,t} - \lambda^{sell}_t P_{sell,t} + \lambda^{grid}(P_{buy,t} + P_{sell,t}) \right) \Delta t + \alpha \left( P_{ch,t}^2 + P_{dis,t}^2 \right) \right] \\
